...
enum opt_code
{
  ...
  OPT_Tbss_ = 146,                           /* -Tbss= */
  OPT_Tdata = 147,                           /* -Tdata */
  OPT_Tdata_ = 148,                          /* -Tdata= */
  OPT_Ttext = 149,                           /* -Ttext */
  OPT_Ttext_ = 150,                          /* -Ttext= */
  OPT_U = 151,                               /* -U */
  /* OPT_W = 152, */                         /* -W */
  OPT_Wa_ = 153,                             /* -Wa, */
  OPT_Wabi = 154,                            /* -Wabi */
  OPT_Wabi_tag = 155,                        /* -Wabi-tag */
  OPT_Wabi_ = 156,                           /* -Wabi= */
  OPT_Wabsolute_value = 157,                 /* -Wabsolute-value */
  OPT_Waddress = 158,                        /* -Waddress */
  OPT_Waddress_of_packed_member = 159,       /* -Waddress-of-packed-member */
  OPT_Waggregate_return = 160,               /* -Waggregate-return */
  OPT_Waggressive_loop_optimizations = 161,  /* -Waggressive-loop-optimizations */
  OPT_Waliasing = 162,                       /* -Waliasing */
  OPT_Walign_commons = 163,                  /* -Walign-commons */
  /* OPT_Waligned_new = 164, */              /* -Waligned-new */
  OPT_Waligned_new_ = 165,                   /* -Waligned-new= */
  OPT_Wall = 166,                            /* -Wall */
  OPT_Walloc_size_larger_than_ = 167,        /* -Walloc-size-larger-than= */
  OPT_Walloc_zero = 168,                     /* -Walloc-zero */
  OPT_Walloca = 169,                         /* -Walloca */
  OPT_Walloca_larger_than_ = 170,            /* -Walloca-larger-than= */
  OPT_Wampersand = 171,                      /* -Wampersand */
  OPT_Wargument_mismatch = 172,              /* -Wargument-mismatch */
  ...
  /* OPT_Wattribute_alias = 177, */          /* -Wattribute-alias */
  OPT_Wattribute_alias_ = 178,               /* -Wattribute-alias= */
  OPT_Wattribute_warning = 179,              /* -Wattribute-warning */
  OPT_Wattributes = 180,                     /* -Wattributes */
  OPT_Wbad_function_cast = 181,              /* -Wbad-function-cast */
  OPT_Wbool_compare = 182,                   /* -Wbool-compare */
  OPT_Wbool_operation = 183,                 /* -Wbool-operation */
  OPT_Wbuiltin_declaration_mismatch = 184,   /* -Wbuiltin-declaration-mismatch */
  OPT_Wbuiltin_macro_redefined = 185,        /* -Wbuiltin-macro-redefined */
  OPT_Wc___compat = 186,                     /* -Wc++-compat */
  /* OPT_Wc__0x_compat = 187, */             /* -Wc++0x-compat */
  OPT_Wc__11_compat = 188,                   /* -Wc++11-compat */
  OPT_Wc__14_compat = 189,                   /* -Wc++14-compat */
  OPT_Wc__17_compat = 190,                   /* -Wc++17-compat */
  /* OPT_Wc__1z_compat = 191, */             /* -Wc++1z-compat */
  OPT_Wc_binding_type = 192,                 /* -Wc-binding-type */
  OPT_Wc11_c2x_compat = 193,                 /* -Wc11-c2x-compat */
  OPT_Wc90_c99_compat = 194,                 /* -Wc90-c99-compat */
  OPT_Wc99_c11_compat = 195,                 /* -Wc99-c11-compat */
  OPT_Wcannot_profile = 196,                 /* -Wcannot-profile */
  OPT_Wcast_align = 197,                     /* -Wcast-align */
  OPT_Wcast_align_strict = 198,              /* -Wcast-align=strict */
  OPT_Wcast_function_type = 199,             /* -Wcast-function-type */
  OPT_Wcast_qual = 200,                      /* -Wcast-qual */
  OPT_Wcast_result = 201,                    /* -Wcast-result */
  /* OPT_Wcatch_value = 202, */              /* -Wcatch-value */
  OPT_Wcatch_value_ = 203,                   /* -Wcatch-value= */
  OPT_Wchar_subscripts = 204,                /* -Wchar-subscripts */
  OPT_Wcharacter_truncation = 205,           /* -Wcharacter-truncation */
  OPT_Wchkp = 206,                           /* -Wchkp */
  OPT_Wclass_conversion = 207,               /* -Wclass-conversion */
  OPT_Wclass_memaccess = 208,                /* -Wclass-memaccess */
  OPT_Wclobbered = 209,                      /* -Wclobbered */
  ...
  OPT_Wformat_extra_args = 254,              /* -Wformat-extra-args */
  OPT_Wformat_nonliteral = 255,              /* -Wformat-nonliteral */
  /* OPT_Wformat_overflow = 256, */          /* -Wformat-overflow */
  OPT_Wformat_overflow_ = 257,               /* -Wformat-overflow= */
  OPT_Wformat_security = 258,                /* -Wformat-security */
  OPT_Wformat_signedness = 259,              /* -Wformat-signedness */
  /* OPT_Wformat_truncation = 260, */        /* -Wformat-truncation */
  OPT_Wformat_truncation_ = 261,             /* -Wformat-truncation= */
  OPT_Wformat_y2k = 262,                     /* -Wformat-y2k */
  OPT_Wformat_zero_length = 263,             /* -Wformat-zero-length */
  OPT_Wformat_ = 264,                        /* -Wformat= */
  OPT_Wframe_address = 265,                  /* -Wframe-address */
  OPT_Wframe_larger_than_ = 266,             /* -Wframe-larger-than= */
  OPT_Wfree_nonheap_object = 267,            /* -Wfree-nonheap-object */
  OPT_Wfrontend_loop_interchange = 268,      /* -Wfrontend-loop-interchange */
  OPT_Wfunction_elimination = 269,           /* -Wfunction-elimination */
  OPT_Whsa = 270,                            /* -Whsa */
  OPT_Wif_not_aligned = 271,                 /* -Wif-not-aligned */
  OPT_Wignored_attributes = 272,             /* -Wignored-attributes */
  OPT_Wignored_qualifiers = 273,             /* -Wignored-qualifiers */
  OPT_Wimplicit = 274,                       /* -Wimplicit */
  /* OPT_Wimplicit_fallthrough = 275, */     /* -Wimplicit-fallthrough */
  OPT_Wimplicit_fallthrough_ = 276,          /* -Wimplicit-fallthrough= */
  OPT_Wimplicit_function_declaration = 277,  /* -Wimplicit-function-declaration */
  OPT_Wimplicit_int = 278,                   /* -Wimplicit-int */
  OPT_Wimplicit_interface = 279,             /* -Wimplicit-interface */
  OPT_Wimplicit_procedure = 280,             /* -Wimplicit-procedure */
  /* OPT_Wimport = 281, */                   /* -Wimport */
  OPT_Wincompatible_pointer_types = 282,     /* -Wincompatible-pointer-types */
  OPT_Winherited_variadic_ctor = 283,        /* -Winherited-variadic-ctor */
  OPT_Winit_list_lifetime = 284,             /* -Winit-list-lifetime */
  OPT_Winit_self = 285,                      /* -Winit-self */
  OPT_Winline = 286,                         /* -Winline */
  OPT_Wint_conversion = 287,                 /* -Wint-conversion */
  OPT_Wint_in_bool_context = 288,            /* -Wint-in-bool-context */
  OPT_Wint_to_pointer_cast = 289,            /* -Wint-to-pointer-cast */
  OPT_Winteger_division = 290,               /* -Winteger-division */
  OPT_Wintrinsic_shadow = 291,               /* -Wintrinsic-shadow */
  OPT_Wintrinsics_std = 292,                 /* -Wintrinsics-std */
  OPT_Winvalid_memory_model = 293,           /* -Winvalid-memory-model */
  OPT_Winvalid_offsetof = 294,               /* -Winvalid-offsetof */
  OPT_Winvalid_pch = 295,                    /* -Winvalid-pch */
  OPT_Wjump_misses_init = 296,               /* -Wjump-misses-init */
  OPT_Wl_ = 297,                             /* -Wl, */
  /* OPT_Wlarger_than_ = 298, */             /* -Wlarger-than- */
  OPT_Wlarger_than_ = 299,                   /* -Wlarger-than= */
  OPT_Wline_truncation = 300,                /* -Wline-truncation */
  OPT_Wliteral_suffix = 301,                 /* -Wliteral-suffix */
  OPT_Wlogical_not_parentheses = 302,        /* -Wlogical-not-parentheses */
  OPT_Wlogical_op = 303,                     /* -Wlogical-op */
  OPT_Wlong_long = 304,                      /* -Wlong-long */
  OPT_Wlto_type_mismatch = 305,              /* -Wlto-type-mismatch */
  OPT_Wmain = 306,                           /* -Wmain */
  OPT_Wmaybe_uninitialized = 307,            /* -Wmaybe-uninitialized */
  OPT_Wmemset_elt_size = 308,                /* -Wmemset-elt-size */
  OPT_Wmemset_transposed_args = 309,         /* -Wmemset-transposed-args */
  OPT_Wmisleading_indentation = 310,         /* -Wmisleading-indentation */
  OPT_Wmissing_attributes = 311,             /* -Wmissing-attributes */
  OPT_Wmissing_braces = 312,                 /* -Wmissing-braces */
  OPT_Wmissing_declarations = 313,           /* -Wmissing-declarations */
  ...
  OPT_Wpragmas = 365,                        /* -Wpragmas */
  OPT_Wprio_ctor_dtor = 366,                 /* -Wprio-ctor-dtor */
  OPT_Wproperty_assign_default = 367,        /* -Wproperty-assign-default */
  OPT_Wprotocol = 368,                       /* -Wprotocol */
  OPT_Wpsabi = 369,                          /* -Wpsabi */
  OPT_Wreal_q_constant = 370,                /* -Wreal-q-constant */
  OPT_Wrealloc_lhs = 371,                    /* -Wrealloc-lhs */
  OPT_Wrealloc_lhs_all = 372,                /* -Wrealloc-lhs-all */
  OPT_Wredundant_decls = 373,                /* -Wredundant-decls */
  OPT_Wredundant_move = 374,                 /* -Wredundant-move */
  OPT_Wregister = 375,                       /* -Wregister */
  OPT_Wreorder = 376,                        /* -Wreorder */
  OPT_Wrestrict = 377,                       /* -Wrestrict */
  OPT_Wreturn_local_addr = 378,              /* -Wreturn-local-addr */
  OPT_Wreturn_type = 379,                    /* -Wreturn-type */
  OPT_Wscalar_storage_order = 380,           /* -Wscalar-storage-order */
  OPT_Wselector = 381,                       /* -Wselector */
  OPT_Wsequence_point = 382,                 /* -Wsequence-point */
  OPT_Wshadow = 383,                         /* -Wshadow */
  /* OPT_Wshadow_compatible_local = 384, */  /* -Wshadow-compatible-local */
  OPT_Wshadow_ivar = 385,                    /* -Wshadow-ivar */
  /* OPT_Wshadow_local = 386, */             /* -Wshadow-local */
  OPT_Wshadow_compatible_local = 387,        /* -Wshadow=compatible-local */
  /* OPT_Wshadow_global = 388, */            /* -Wshadow=global */
  OPT_Wshadow_local = 389,                   /* -Wshadow=local */
  OPT_Wshift_count_negative = 390,           /* -Wshift-count-negative */
  OPT_Wshift_count_overflow = 391,           /* -Wshift-count-overflow */
  OPT_Wshift_negative_value = 392,           /* -Wshift-negative-value */
  /* OPT_Wshift_overflow = 393, */           /* -Wshift-overflow */
  OPT_Wshift_overflow_ = 394,                /* -Wshift-overflow= */
  OPT_Wsign_compare = 395,                   /* -Wsign-compare */
  OPT_Wsign_conversion = 396,                /* -Wsign-conversion */
  OPT_Wsign_promo = 397,                     /* -Wsign-promo */
  OPT_Wsized_deallocation = 398,             /* -Wsized-deallocation */
  OPT_Wsizeof_array_argument = 399,          /* -Wsizeof-array-argument */
  OPT_Wsizeof_pointer_div = 400,             /* -Wsizeof-pointer-div */
  OPT_Wsizeof_pointer_memaccess = 401,       /* -Wsizeof-pointer-memaccess */
  OPT_Wspeculative = 402,                    /* -Wspeculative */
  OPT_Wstack_protector = 403,                /* -Wstack-protector */
  OPT_Wstack_usage_ = 404,                   /* -Wstack-usage= */
  OPT_Wstrict_aliasing = 405,                /* -Wstrict-aliasing */
  OPT_Wstrict_aliasing_ = 406,               /* -Wstrict-aliasing= */
  OPT_Wstrict_null_sentinel = 407,           /* -Wstrict-null-sentinel */
  OPT_Wstrict_overflow = 408,                /* -Wstrict-overflow */
  OPT_Wstrict_overflow_ = 409,               /* -Wstrict-overflow= */
  OPT_Wstrict_prototypes = 410,              /* -Wstrict-prototypes */
  OPT_Wstrict_selector_match = 411,          /* -Wstrict-selector-match */
  /* OPT_Wstringop_overflow = 412, */        /* -Wstringop-overflow */
  OPT_Wstringop_overflow_ = 413,             /* -Wstringop-overflow= */
  OPT_Wstringop_truncation = 414,            /* -Wstringop-truncation */
  OPT_Wsubobject_linkage = 415,              /* -Wsubobject-linkage */
  OPT_Wsuggest_attribute_cold = 416,         /* -Wsuggest-attribute=cold */
  OPT_Wsuggest_attribute_const = 417,        /* -Wsuggest-attribute=const */
  OPT_Wsuggest_attribute_format = 418,       /* -Wsuggest-attribute=format */
  OPT_Wsuggest_attribute_malloc = 419,       /* -Wsuggest-attribute=malloc */
  OPT_Wsuggest_attribute_noreturn = 420,     /* -Wsuggest-attribute=noreturn */
  OPT_Wsuggest_attribute_pure = 421,         /* -Wsuggest-attribute=pure */
  OPT_Wsuggest_final_methods = 422,          /* -Wsuggest-final-methods */
  OPT_Wsuggest_final_types = 423,            /* -Wsuggest-final-types */
  OPT_Wsuggest_override = 424,               /* -Wsuggest-override */
  OPT_Wsurprising = 425,                     /* -Wsurprising */
  OPT_Wswitch = 426,                         /* -Wswitch */
  OPT_Wswitch_bool = 427,                    /* -Wswitch-bool */
  OPT_Wswitch_default = 428,                 /* -Wswitch-default */
  OPT_Wswitch_enum = 429,                    /* -Wswitch-enum */
  OPT_Wswitch_unreachable = 430,             /* -Wswitch-unreachable */
  OPT_Wsync_nand = 431,                      /* -Wsync-nand */
  OPT_Wsynth = 432,                          /* -Wsynth */
  OPT_Wsystem_headers = 433,                 /* -Wsystem-headers */
  OPT_Wtabs = 434,                           /* -Wtabs */
  OPT_Wtarget_lifetime = 435,                /* -Wtarget-lifetime */
  OPT_Wtautological_compare = 436,           /* -Wtautological-compare */
  OPT_Wtemplates = 437,                      /* -Wtemplates */
  OPT_Wterminate = 438,                      /* -Wterminate */
  OPT_Wtraditional = 439,                    /* -Wtraditional */
  OPT_Wtraditional_conversion = 440,         /* -Wtraditional-conversion */
  OPT_Wtrampolines = 441,                    /* -Wtrampolines */
  OPT_Wtrigraphs = 442,                      /* -Wtrigraphs */
  OPT_Wtype_limits = 443,                    /* -Wtype-limits */
  OPT_Wundeclared_selector = 444,            /* -Wundeclared-selector */
  OPT_Wundef = 445,                          /* -Wundef */
  OPT_Wundefined_do_loop = 446,              /* -Wundefined-do-loop */
  OPT_Wunderflow = 447,                      /* -Wunderflow */
  OPT_Wuninitialized = 448,                  /* -Wuninitialized */
  OPT_Wunknown_pragmas = 449,                /* -Wunknown-pragmas */
  /* OPT_Wunreachable_code = 450, */         /* -Wunreachable-code */
  /* OPT_Wunsafe_loop_optimizations = 451, *//* -Wunsafe-loop-optimizations */
  OPT_Wunsuffixed_float_constants = 452,     /* -Wunsuffixed-float-constants */
  OPT_Wunused = 453,                         /* -Wunused */
  OPT_Wunused_but_set_parameter = 454,       /* -Wunused-but-set-parameter */
  OPT_Wunused_but_set_variable = 455,        /* -Wunused-but-set-variable */
  /* OPT_Wunused_const_variable = 456, */    /* -Wunused-const-variable */
  OPT_Wunused_const_variable_ = 457,         /* -Wunused-const-variable= */
  OPT_Wunused_dummy_argument = 458,          /* -Wunused-dummy-argument */
  OPT_Wunused_function = 459,                /* -Wunused-function */
  OPT_Wunused_label = 460,                   /* -Wunused-label */
  OPT_Wunused_local_typedefs = 461,          /* -Wunused-local-typedefs */
  OPT_Wunused_macros = 462,                  /* -Wunused-macros */
  OPT_Wunused_parameter = 463,               /* -Wunused-parameter */
  OPT_Wunused_result = 464,                  /* -Wunused-result */
  OPT_Wunused_value = 465,                   /* -Wunused-value */
  OPT_Wunused_variable = 466,                /* -Wunused-variable */
  OPT_Wuse_without_only = 467,               /* -Wuse-without-only */
  OPT_Wuseless_cast = 468,                   /* -Wuseless-cast */
  OPT_Wvarargs = 469,                        /* -Wvarargs */
  OPT_Wvariadic_macros = 470,                /* -Wvariadic-macros */
  OPT_Wvector_operation_performance = 471,   /* -Wvector-operation-performance */
  OPT_Wvirtual_inheritance = 472,            /* -Wvirtual-inheritance */
  OPT_Wvirtual_move_assign = 473,            /* -Wvirtual-move-assign */
  OPT_Wvla = 474,                            /* -Wvla */
  OPT_Wvla_larger_than_ = 475,               /* -Wvla-larger-than= */
  OPT_Wvolatile_register_var = 476,          /* -Wvolatile-register-var */
  OPT_Wwrite_strings = 477,                  /* -Wwrite-strings */
  OPT_Wzero_as_null_pointer_constant = 478,  /* -Wzero-as-null-pointer-constant */
  OPT_Wzerotrip = 479,                       /* -Wzerotrip */
  OPT_X = 480,                               /* -X */
  OPT_Xassembler = 481,                      /* -Xassembler */
  OPT_Xf = 482,                              /* -Xf */
  OPT_Xlinker = 483,                         /* -Xlinker */
  OPT_Xpreprocessor = 484,                   /* -Xpreprocessor */
  OPT_Z = 485,                               /* -Z */
  OPT_ansi = 486,                            /* -ansi */
  OPT_aux_info = 487,                        /* -aux-info */
  /* OPT_aux_info_ = 488, */                 /* -aux-info= */
  OPT_auxbase = 489,                         /* -auxbase */
  OPT_auxbase_strip = 490,                   /* -auxbase-strip */
  OPT_c = 491,                               /* -c */
  OPT_coverage = 492,                        /* -coverage */
  OPT_cpp = 493,                             /* -cpp */
  OPT_cpp_ = 494,                            /* -cpp= */
  OPT_d = 495,                               /* -d */
  OPT_debuglib_ = 496,                       /* -debuglib= */
  OPT_defaultlib_ = 497,                     /* -defaultlib= */
  OPT_dstartfiles = 498,                     /* -dstartfiles */
  OPT_dumpbase = 499,                        /* -dumpbase */
  OPT_dumpdir = 500,                         /* -dumpdir */
  OPT_dumpfullversion = 501,                 /* -dumpfullversion */
  OPT_dumpmachine = 502,                     /* -dumpmachine */
  OPT_dumpspecs = 503,                       /* -dumpspecs */
  OPT_dumpversion = 504,                     /* -dumpversion */
  OPT_e = 505,                               /* -e */
  OPT_export_dynamic = 506,                  /* -export-dynamic */
  OPT_fPIC = 507,                            /* -fPIC */
  OPT_fPIE = 508,                            /* -fPIE */
  OPT_fRTS_ = 509,                           /* -fRTS= */
  OPT_fabi_compat_version_ = 510,            /* -fabi-compat-version= */
  OPT_fabi_version_ = 511,                   /* -fabi-version= */
  OPT_faccess_control = 512,                 /* -faccess-control */
  OPT_fada_spec_parent_ = 513,               /* -fada-spec-parent= */
  OPT_faggressive_function_elimination = 514,/* -faggressive-function-elimination */
  OPT_faggressive_loop_optimizations = 515,  /* -faggressive-loop-optimizations */
  OPT_falign_commons = 516,                  /* -falign-commons */
  OPT_falign_functions = 517,                /* -falign-functions */
  OPT_falign_functions_ = 518,               /* -falign-functions= */
  OPT_falign_jumps = 519,                    /* -falign-jumps */
  OPT_falign_jumps_ = 520,                   /* -falign-jumps= */
  OPT_falign_labels = 521,                   /* -falign-labels */
  OPT_falign_labels_ = 522,                  /* -falign-labels= */
  OPT_falign_loops = 523,                    /* -falign-loops */
  OPT_falign_loops_ = 524,                   /* -falign-loops= */
  /* OPT_faligned_new = 525, */              /* -faligned-new */
  OPT_faligned_new_ = 526,                   /* -faligned-new= */
  OPT_fall_instantiations = 527,             /* -fall-instantiations */
  OPT_fall_intrinsics = 528,                 /* -fall-intrinsics */
  OPT_fall_virtual = 529,                    /* -fall-virtual */
  OPT_fallow_leading_underscore = 530,       /* -fallow-leading-underscore */
  OPT_fallow_parameterless_variadic_functions = 531,/* -fallow-parameterless-variadic-functions */
  OPT_falt_external_templates = 532,         /* -falt-external-templates */
  /* OPT_fargument_alias = 533, */           /* -fargument-alias */
  /* OPT_fargument_noalias = 534, */         /* -fargument-noalias */
  /* OPT_fargument_noalias_anything = 535, *//* -fargument-noalias-anything */
  /* OPT_fargument_noalias_global = 536, */  /* -fargument-noalias-global */
  OPT_fasan_shadow_offset_ = 537,            /* -fasan-shadow-offset= */
  OPT_fasm = 538,                            /* -fasm */
  OPT_fassert = 539,                         /* -fassert */
  OPT_fassociative_math = 540,               /* -fassociative-math */
  OPT_fassume_phsa = 541,                    /* -fassume-phsa */
  OPT_fasynchronous_unwind_tables = 542,     /* -fasynchronous-unwind-tables */
  OPT_fauto_inc_dec = 543,                   /* -fauto-inc-dec */
  OPT_fauto_profile = 544,                   /* -fauto-profile */
  OPT_fauto_profile_ = 545,                  /* -fauto-profile= */
  OPT_fautomatic = 546,                      /* -fautomatic */
  OPT_fbackslash = 547,                      /* -fbackslash */
  OPT_fbacktrace = 548,                      /* -fbacktrace */
  OPT_fblas_matmul_limit_ = 549,             /* -fblas-matmul-limit= */
  OPT_fbounds_check = 550,                   /* -fbounds-check */
  OPT_fbounds_check_ = 551,                  /* -fbounds-check= */
  OPT_fbranch_count_reg = 552,               /* -fbranch-count-reg */
  OPT_fbranch_probabilities = 553,           /* -fbranch-probabilities */
  OPT_fbranch_target_load_optimize = 554,    /* -fbranch-target-load-optimize */
  OPT_fbranch_target_load_optimize2 = 555,   /* -fbranch-target-load-optimize2 */
  OPT_fbtr_bb_exclusive = 556,               /* -fbtr-bb-exclusive */
  OPT_fbuilding_libgcc = 557,                /* -fbuilding-libgcc */
  OPT_fbuilding_libphobos_tests = 558,       /* -fbuilding-libphobos-tests */
  OPT_fbuiltin = 559,                        /* -fbuiltin */
  OPT_fbuiltin_ = 560,                       /* -fbuiltin- */
  OPT_fbuiltin_printf = 561,                 /* -fbuiltin-printf */
  OPT_fc_prototypes = 562,                   /* -fc-prototypes */
  OPT_fcall_saved_ = 563,                    /* -fcall-saved- */
  OPT_fcall_used_ = 564,                     /* -fcall-used- */
  OPT_fcaller_saves = 565,                   /* -fcaller-saves */
  OPT_fcanonical_system_headers = 566,       /* -fcanonical-system-headers */
  /* OPT_fcf_protection = 567, */            /* -fcf-protection */
  OPT_fcf_protection_ = 568,                 /* -fcf-protection= */
  OPT_fchar8_t = 569,                        /* -fchar8_t */
  OPT_fcheck_array_temporaries = 570,        /* -fcheck-array-temporaries */
  /* OPT_fcheck_data_deps = 571, */          /* -fcheck-data-deps */
  OPT_fcheck_new = 572,                      /* -fcheck-new */
  OPT_fcheck_pointer_bounds = 573,           /* -fcheck-pointer-bounds */
  OPT_fcheck_ = 574,                         /* -fcheck= */
  OPT_fchecking = 575,                       /* -fchecking */
  OPT_fchecking_ = 576,                      /* -fchecking= */
  OPT_fchkp_check_incomplete_type = 577,     /* -fchkp-check-incomplete-type */
  OPT_fchkp_check_read = 578,                /* -fchkp-check-read */
  OPT_fchkp_check_write = 579,               /* -fchkp-check-write */
  OPT_fchkp_first_field_has_own_bounds = 580,/* -fchkp-first-field-has-own-bounds */
  OPT_fchkp_flexible_struct_trailing_arrays = 581,/* -fchkp-flexible-struct-trailing-arrays */
  OPT_fchkp_instrument_calls = 582,          /* -fchkp-instrument-calls */
  OPT_fchkp_instrument_marked_only = 583,    /* -fchkp-instrument-marked-only */
  OPT_fchkp_narrow_bounds = 584,             /* -fchkp-narrow-bounds */
  OPT_fchkp_narrow_to_innermost_array = 585, /* -fchkp-narrow-to-innermost-array */
  OPT_fchkp_optimize = 586,                  /* -fchkp-optimize */
  OPT_fchkp_store_bounds = 587,              /* -fchkp-store-bounds */
  OPT_fchkp_treat_zero_dynamic_size_as_infinite = 588,/* -fchkp-treat-zero-dynamic-size-as-infinite */
  OPT_fchkp_use_fast_string_functions = 589, /* -fchkp-use-fast-string-functions */
  OPT_fchkp_use_nochk_string_functions = 590,/* -fchkp-use-nochk-string-functions */
  OPT_fchkp_use_static_bounds = 591,         /* -fchkp-use-static-bounds */
  OPT_fchkp_use_static_const_bounds = 592,   /* -fchkp-use-static-const-bounds */
  OPT_fchkp_use_wrappers = 593,              /* -fchkp-use-wrappers */
  OPT_fchkp_zero_input_bounds_for_main = 594,/* -fchkp-zero-input-bounds-for-main */
  /* OPT_fcilkplus = 595, */                 /* -fcilkplus */
  OPT_fcoarray_ = 596,                       /* -fcoarray= */
  OPT_fcode_hoisting = 597,                  /* -fcode-hoisting */
  OPT_fcombine_stack_adjustments = 598,      /* -fcombine-stack-adjustments */
  OPT_fcommon = 599,                         /* -fcommon */
  OPT_fcompare_debug = 600,                  /* -fcompare-debug */
  OPT_fcompare_debug_second = 601,           /* -fcompare-debug-second */
  OPT_fcompare_debug_ = 602,                 /* -fcompare-debug= */
  OPT_fcompare_elim = 603,                   /* -fcompare-elim */
  OPT_fconcepts = 604,                       /* -fconcepts */
  OPT_fcond_mismatch = 605,                  /* -fcond-mismatch */
  /* OPT_fconserve_space = 606, */           /* -fconserve-space */
  OPT_fconserve_stack = 607,                 /* -fconserve-stack */
  OPT_fconstant_string_class_ = 608,         /* -fconstant-string-class= */
  OPT_fconstexpr_depth_ = 609,               /* -fconstexpr-depth= */
  OPT_fconstexpr_loop_limit_ = 610,          /* -fconstexpr-loop-limit= */
  OPT_fconstexpr_ops_limit_ = 611,           /* -fconstexpr-ops-limit= */
  OPT_fconvert_ = 612,                       /* -fconvert= */
  OPT_fcprop_registers = 613,                /* -fcprop-registers */
  OPT_fcray_pointer = 614,                   /* -fcray-pointer */
  OPT_fcrossjumping = 615,                   /* -fcrossjumping */
  OPT_fcse_follow_jumps = 616,               /* -fcse-follow-jumps */
  /* OPT_fcse_skip_blocks = 617, */          /* -fcse-skip-blocks */
  OPT_fcx_fortran_rules = 618,               /* -fcx-fortran-rules */
  OPT_fcx_limited_range = 619,               /* -fcx-limited-range */
  OPT_fd_lines_as_code = 620,                /* -fd-lines-as-code */
  OPT_fd_lines_as_comments = 621,            /* -fd-lines-as-comments */
  OPT_fdata_sections = 622,                  /* -fdata-sections */
  OPT_fdbg_cnt_list = 623,                   /* -fdbg-cnt-list */
  OPT_fdbg_cnt_ = 624,                       /* -fdbg-cnt= */
  OPT_fdce = 625,                            /* -fdce */
  OPT_fdebug = 626,                          /* -fdebug */
  ...
  OPT_fdebug_ = 630,                         /* -fdebug= */
  OPT_fdec = 631,                            /* -fdec */
  OPT_fdec_include = 632,                    /* -fdec-include */
  OPT_fdec_intrinsic_ints = 633,             /* -fdec-intrinsic-ints */
  OPT_fdec_math = 634,                       /* -fdec-math */
  OPT_fdec_static = 635,                     /* -fdec-static */
  OPT_fdec_structure = 636,                  /* -fdec-structure */
  OPT_fdeclone_ctor_dtor = 637,              /* -fdeclone-ctor-dtor */
  OPT_fdeduce_init_list = 638,               /* -fdeduce-init-list */
  OPT_fdefault_double_8 = 639,               /* -fdefault-double-8 */
  /* OPT_fdefault_inline = 640, */           /* -fdefault-inline */
  OPT_fdefault_integer_8 = 641,              /* -fdefault-integer-8 */
  OPT_fdefault_real_10 = 642,                /* -fdefault-real-10 */
  OPT_fdefault_real_16 = 643,                /* -fdefault-real-16 */
  OPT_fdefault_real_8 = 644,                 /* -fdefault-real-8 */
  OPT_fdefer_pop = 645,                      /* -fdefer-pop */
  OPT_fdelayed_branch = 646,                 /* -fdelayed-branch */
  OPT_fdelete_dead_exceptions = 647,         /* -fdelete-dead-exceptions */
  OPT_fdelete_null_pointer_checks = 648,     /* -fdelete-null-pointer-checks */
  OPT_fdevirtualize = 649,                   /* -fdevirtualize */
  OPT_fdevirtualize_at_ltrans = 650,         /* -fdevirtualize-at-ltrans */
  OPT_fdevirtualize_speculatively = 651,     /* -fdevirtualize-speculatively */
  /* OPT_fdiagnostics_color = 652, */        /* -fdiagnostics-color */
  OPT_fdiagnostics_color_ = 653,             /* -fdiagnostics-color= */
  OPT_fdiagnostics_format_ = 654,            /* -fdiagnostics-format= */
  OPT_fdiagnostics_generate_patch = 655,     /* -fdiagnostics-generate-patch */
  OPT_fdiagnostics_minimum_margin_width_ = 656,/* -fdiagnostics-minimum-margin-width= */
  OPT_fdiagnostics_parseable_fixits = 657,   /* -fdiagnostics-parseable-fixits */
  OPT_fdiagnostics_show_caret = 658,         /* -fdiagnostics-show-caret */
  OPT_fdiagnostics_show_labels = 659,        /* -fdiagnostics-show-labels */
  OPT_fdiagnostics_show_line_numbers = 660,  /* -fdiagnostics-show-line-numbers */
  OPT_fdiagnostics_show_location_ = 661,     /* -fdiagnostics-show-location= */
  OPT_fdiagnostics_show_option = 662,        /* -fdiagnostics-show-option */
  OPT_fdiagnostics_show_template_tree = 663, /* -fdiagnostics-show-template-tree */
  OPT_fdirectives_only = 664,                /* -fdirectives-only */
  OPT_fdisable_ = 665,                       /* -fdisable- */
  OPT_fdoc = 666,                            /* -fdoc */
  OPT_fdoc_dir_ = 667,                       /* -fdoc-dir= */
  OPT_fdoc_file_ = 668,                      /* -fdoc-file= */
  OPT_fdoc_inc_ = 669,                       /* -fdoc-inc= */
  OPT_fdollar_ok = 670,                      /* -fdollar-ok */
  OPT_fdollars_in_identifiers = 671,         /* -fdollars-in-identifiers */
  OPT_fdruntime = 672,                       /* -fdruntime */
  OPT_fdse = 673,                            /* -fdse */
  OPT_fdump_ = 674,                          /* -fdump- */
  OPT_fdump_ada_spec = 675,                  /* -fdump-ada-spec */
  OPT_fdump_ada_spec_slim = 676,             /* -fdump-ada-spec-slim */
  /* OPT_fdump_core = 677, */                /* -fdump-core */
  OPT_fdump_d_original = 678,                /* -fdump-d-original */
  OPT_fdump_final_insns = 679,               /* -fdump-final-insns */
  OPT_fdump_final_insns_ = 680,              /* -fdump-final-insns= */
  ...
  /* OPT_ftarget_help = 1096, */             /* -ftarget-help */
  OPT_ftemplate_backtrace_limit_ = 1097,     /* -ftemplate-backtrace-limit= */
  /* OPT_ftemplate_depth_ = 1098, */         /* -ftemplate-depth- */
  OPT_ftemplate_depth_ = 1099,               /* -ftemplate-depth= */
  OPT_ftest_coverage = 1100,                 /* -ftest-coverage */
  OPT_ftest_forall_temp = 1101,              /* -ftest-forall-temp */
  OPT_fthis_is_variable = 1102,              /* -fthis-is-variable */
  OPT_fthread_jumps = 1103,                  /* -fthread-jumps */
  OPT_fthreadsafe_statics = 1104,            /* -fthreadsafe-statics */
  OPT_ftime_report = 1105,                   /* -ftime-report */
  OPT_ftime_report_details = 1106,           /* -ftime-report-details */
  OPT_ftls_model_ = 1107,                    /* -ftls-model= */
  OPT_ftoplevel_reorder = 1108,              /* -ftoplevel-reorder */
  OPT_ftracer = 1109,                        /* -ftracer */
  OPT_ftrack_macro_expansion = 1110,         /* -ftrack-macro-expansion */
  OPT_ftrack_macro_expansion_ = 1111,        /* -ftrack-macro-expansion= */
  OPT_ftrampolines = 1112,                   /* -ftrampolines */
  OPT_ftransition_all = 1113,                /* -ftransition=all */
  OPT_ftransition_checkimports = 1114,       /* -ftransition=checkimports */
  OPT_ftransition_complex = 1115,            /* -ftransition=complex */
  OPT_ftransition_dip1000 = 1116,            /* -ftransition=dip1000 */
  OPT_ftransition_dip25 = 1117,              /* -ftransition=dip25 */
  OPT_ftransition_field = 1118,              /* -ftransition=field */
  OPT_ftransition_import = 1119,             /* -ftransition=import */
  OPT_ftransition_nogc = 1120,               /* -ftransition=nogc */
  OPT_ftransition_tls = 1121,                /* -ftransition=tls */
  OPT_ftrapping_math = 1122,                 /* -ftrapping-math */
  OPT_ftrapv = 1123,                         /* -ftrapv */
  OPT_ftree_bit_ccp = 1124,                  /* -ftree-bit-ccp */
  OPT_ftree_builtin_call_dce = 1125,         /* -ftree-builtin-call-dce */
  OPT_ftree_ccp = 1126,                      /* -ftree-ccp */
  OPT_ftree_ch = 1127,                       /* -ftree-ch */
  /* OPT_ftree_coalesce_inlined_vars = 1128, *//* -ftree-coalesce-inlined-vars */
  OPT_ftree_coalesce_vars = 1129,            /* -ftree-coalesce-vars */
  OPT_ftree_copy_prop = 1130,                /* -ftree-copy-prop */
  /* OPT_ftree_copyrename = 1131, */         /* -ftree-copyrename */
  OPT_ftree_cselim = 1132,                   /* -ftree-cselim */
  OPT_ftree_dce = 1133,                      /* -ftree-dce */
  OPT_ftree_dominator_opts = 1134,           /* -ftree-dominator-opts */
  OPT_ftree_dse = 1135,                      /* -ftree-dse */
  OPT_ftree_forwprop = 1136,                 /* -ftree-forwprop */
  OPT_ftree_fre = 1137,                      /* -ftree-fre */
  OPT_ftree_loop_distribute_patterns = 1138, /* -ftree-loop-distribute-patterns */
  OPT_ftree_loop_distribution = 1139,        /* -ftree-loop-distribution */
  OPT_ftree_loop_if_convert = 1140,          /* -ftree-loop-if-convert */
  /* OPT_ftree_loop_if_convert_stores = 1141, *//* -ftree-loop-if-convert-stores */
  OPT_ftree_loop_im = 1142,                  /* -ftree-loop-im */
  OPT_ftree_loop_ivcanon = 1143,             /* -ftree-loop-ivcanon */
  /* OPT_ftree_loop_linear = 1144, */        /* -ftree-loop-linear */
  OPT_ftree_loop_optimize = 1145,            /* -ftree-loop-optimize */
  OPT_ftree_loop_vectorize = 1146,           /* -ftree-loop-vectorize */
  OPT_ftree_lrs = 1147,                      /* -ftree-lrs */
  OPT_ftree_parallelize_loops_ = 1148,       /* -ftree-parallelize-loops= */
  OPT_ftree_partial_pre = 1149,              /* -ftree-partial-pre */
  OPT_ftree_phiprop = 1150,                  /* -ftree-phiprop */
  OPT_ftree_pre = 1151,                      /* -ftree-pre */
  OPT_ftree_pta = 1152,                      /* -ftree-pta */
  OPT_ftree_reassoc = 1153,                  /* -ftree-reassoc */
  /* OPT_ftree_salias = 1154, */             /* -ftree-salias */
  OPT_ftree_scev_cprop = 1155,               /* -ftree-scev-cprop */
  OPT_ftree_sink = 1156,                     /* -ftree-sink */
  OPT_ftree_slp_vectorize = 1157,            /* -ftree-slp-vectorize */
  OPT_ftree_slsr = 1158,                     /* -ftree-slsr */
  OPT_ftree_sra = 1159,                      /* -ftree-sra */
  /* OPT_ftree_store_ccp = 1160, */          /* -ftree-store-ccp */
  /* OPT_ftree_store_copy_prop = 1161, */    /* -ftree-store-copy-prop */
  OPT_ftree_switch_conversion = 1162,        /* -ftree-switch-conversion */
  OPT_ftree_tail_merge = 1163,               /* -ftree-tail-merge */
  OPT_ftree_ter = 1164,                      /* -ftree-ter */
  /* OPT_ftree_vect_loop_version = 1165, */  /* -ftree-vect-loop-version */
  OPT_ftree_vectorize = 1166,                /* -ftree-vectorize */
  /* OPT_ftree_vectorizer_verbose_ = 1167, *//* -ftree-vectorizer-verbose= */
  OPT_ftree_vrp = 1168,                      /* -ftree-vrp */
  OPT_funconstrained_commons = 1169,         /* -funconstrained-commons */
  OPT_funderscoring = 1170,                  /* -funderscoring */
  OPT_funit_at_a_time = 1171,                /* -funit-at-a-time */
  OPT_funittest = 1172,                      /* -funittest */
  OPT_funroll_all_loops = 1173,              /* -funroll-all-loops */
  OPT_funroll_loops = 1174,                  /* -funroll-loops */
  /* OPT_funsafe_loop_optimizations = 1175, *//* -funsafe-loop-optimizations */
  OPT_funsafe_math_optimizations = 1176,     /* -funsafe-math-optimizations */
  OPT_funsigned_bitfields = 1177,            /* -funsigned-bitfields */
  OPT_funsigned_char = 1178,                 /* -funsigned-char */
  OPT_funswitch_loops = 1179,                /* -funswitch-loops */
  OPT_funwind_tables = 1180,                 /* -funwind-tables */
  OPT_fuse_cxa_atexit = 1181,                /* -fuse-cxa-atexit */
  OPT_fuse_cxa_get_exception_ptr = 1182,     /* -fuse-cxa-get-exception-ptr */
  OPT_fuse_ld_bfd = 1183,                    /* -fuse-ld=bfd */
  OPT_fuse_ld_gold = 1184,                   /* -fuse-ld=gold */
  OPT_fuse_ld_lld = 1185,                    /* -fuse-ld=lld */
  OPT_fuse_linker_plugin = 1186,             /* -fuse-linker-plugin */
  OPT_fvar_tracking = 1187,                  /* -fvar-tracking */
  OPT_fvar_tracking_assignments = 1188,      /* -fvar-tracking-assignments */
  OPT_fvar_tracking_assignments_toggle = 1189,/* -fvar-tracking-assignments-toggle */
  OPT_fvar_tracking_uninit = 1190,           /* -fvar-tracking-uninit */
  OPT_fvariable_expansion_in_unroller = 1191,/* -fvariable-expansion-in-unroller */
  /* OPT_fvect_cost_model = 1192, */         /* -fvect-cost-model */
  OPT_fvect_cost_model_ = 1193,              /* -fvect-cost-model= */
  OPT_fverbose_asm = 1194,                   /* -fverbose-asm */
  /* OPT_fversion = 1195, */                 /* -fversion */
  OPT_fversion_loops_for_strides = 1196,     /* -fversion-loops-for-strides */
  OPT_fversion_ = 1197,                      /* -fversion= */
  OPT_fvisibility_inlines_hidden = 1198,     /* -fvisibility-inlines-hidden */
  OPT_fvisibility_ms_compat = 1199,          /* -fvisibility-ms-compat */
  OPT_fvisibility_ = 1200,                   /* -fvisibility= */
  OPT_fvpt = 1201,                           /* -fvpt */
  OPT_fvtable_gc = 1202,                     /* -fvtable-gc */
  OPT_fvtable_thunks = 1203,                 /* -fvtable-thunks */
  OPT_fvtable_verify_ = 1204,                /* -fvtable-verify= */
  OPT_fvtv_counts = 1205,                    /* -fvtv-counts */
  OPT_fvtv_debug = 1206,                     /* -fvtv-debug */
  OPT_fweak = 1207,                          /* -fweak */
  OPT_fweb = 1208,                           /* -fweb */
  /* OPT_fwhole_file = 1209, */              /* -fwhole-file */
  OPT_fwhole_program = 1210,                 /* -fwhole-program */
  OPT_fwide_exec_charset_ = 1211,            /* -fwide-exec-charset= */
  OPT_fworking_directory = 1212,             /* -fworking-directory */
  OPT_fwpa = 1213,                           /* -fwpa */
  OPT_fwpa_ = 1214,                          /* -fwpa= */
  OPT_fwrapv = 1215,                         /* -fwrapv */
  OPT_fwrapv_pointer = 1216,                 /* -fwrapv-pointer */
  ...
  OPT_mabi_ = 1273,                          /* -mabi= */
  OPT_mabicalls = 1274,                      /* -mabicalls */
  OPT_mabs_ = 1275,                          /* -mabs= */
  OPT_march_ = 1276,                         /* -march= */
  OPT_mbranch_cost_ = 1277,                  /* -mbranch-cost= */
  OPT_mbranch_likely = 1278,                 /* -mbranch-likely */
  OPT_mcheck_zero_division = 1279,           /* -mcheck-zero-division */
  OPT_mcode_readable_ = 1280,                /* -mcode-readable= */
  OPT_mcompact_branches_ = 1281,             /* -mcompact-branches= */
  OPT_mcrc = 1282,                           /* -mcrc */
  OPT_mdebug = 1283,                         /* -mdebug */
  OPT_mdebugd = 1284,                        /* -mdebugd */
  OPT_mdivide_breaks = 1285,                 /* -mdivide-breaks */
  OPT_mdivide_traps = 1286,                  /* -mdivide-traps */
  OPT_mdmx = 1287,                           /* -mdmx */
  OPT_mdouble_float = 1288,                  /* -mdouble-float */
  OPT_mdsp = 1289,                           /* -mdsp */
  OPT_mdspr2 = 1290,                         /* -mdspr2 */
  OPT_meb = 1291,                            /* -meb */
  OPT_mel = 1292,                            /* -mel */
  OPT_membedded_data = 1293,                 /* -membedded-data */
  OPT_meva = 1294,                           /* -meva */
  OPT_mexplicit_relocs = 1295,               /* -mexplicit-relocs */
  OPT_mextern_sdata = 1296,                  /* -mextern-sdata */
  OPT_mfix_24k = 1297,                       /* -mfix-24k */
  OPT_mfix_r10000 = 1298,                    /* -mfix-r10000 */
  OPT_mfix_r4000 = 1299,                     /* -mfix-r4000 */
  OPT_mfix_r4400 = 1300,                     /* -mfix-r4400 */
  OPT_mfix_r5900 = 1301,                     /* -mfix-r5900 */
  OPT_mfix_rm7000 = 1302,                    /* -mfix-rm7000 */
  OPT_mfix_sb1 = 1303,                       /* -mfix-sb1 */
  OPT_mfix_vr4120 = 1304,                    /* -mfix-vr4120 */
  OPT_mfix_vr4130 = 1305,                    /* -mfix-vr4130 */
  OPT_mfix4300 = 1306,                       /* -mfix4300 */
  OPT_mflip_mips16 = 1307,                   /* -mflip-mips16 */
  OPT_mflush_func_ = 1308,                   /* -mflush-func= */
  OPT_mfp_exceptions = 1309,                 /* -mfp-exceptions */
  OPT_mfp32 = 1310,                          /* -mfp32 */
  OPT_mfp64 = 1311,                          /* -mfp64 */
  OPT_mfpxx = 1312,                          /* -mfpxx */
  OPT_mframe_header_opt = 1313,              /* -mframe-header-opt */
  /* OPT_mfused_madd = 1314, */              /* -mfused-madd */
  OPT_mginv = 1315,                          /* -mginv */
  OPT_mgp32 = 1316,                          /* -mgp32 */
  OPT_mgp64 = 1317,                          /* -mgp64 */
  OPT_mgpopt = 1318,                         /* -mgpopt */
  OPT_mhard_float = 1319,                    /* -mhard-float */
  OPT_mimadd = 1320,                         /* -mimadd */
  OPT_minterlink_compressed = 1321,          /* -minterlink-compressed */
  OPT_minterlink_mips16 = 1322,              /* -minterlink-mips16 */
  OPT_mips = 1323,                           /* -mips */
  OPT_mips16 = 1324,                         /* -mips16 */
  OPT_mips3d = 1325,                         /* -mips3d */
  OPT_mllsc = 1326,                          /* -mllsc */
  OPT_mload_store_pairs = 1327,              /* -mload-store-pairs */
  OPT_mlocal_sdata = 1328,                   /* -mlocal-sdata */
  OPT_mlong_calls = 1329,                    /* -mlong-calls */
  OPT_mlong32 = 1330,                        /* -mlong32 */
  OPT_mlong64 = 1331,                        /* -mlong64 */
  OPT_mloongson_ext = 1332,                  /* -mloongson-ext */
  OPT_mloongson_ext2 = 1333,                 /* -mloongson-ext2 */
  OPT_mloongson_mmi = 1334,                  /* -mloongson-mmi */
  OPT_mlra = 1335,                           /* -mlra */
  OPT_mlxc1_sxc1 = 1336,                     /* -mlxc1-sxc1 */
  OPT_mmad = 1337,                           /* -mmad */
  OPT_mmadd4 = 1338,                         /* -mmadd4 */
  OPT_mmcount_ra_address = 1339,             /* -mmcount-ra-address */
  OPT_mmcu = 1340,                           /* -mmcu */
  OPT_mmemcpy = 1341,                        /* -mmemcpy */
  OPT_mmicromips = 1342,                     /* -mmicromips */
  OPT_mmsa = 1343,                           /* -mmsa */
  OPT_mmt = 1344,                            /* -mmt */
  OPT_mnan_ = 1345,                          /* -mnan= */
  OPT_mno_float = 1346,                      /* -mno-float */
  OPT_mno_flush_func = 1347,                 /* -mno-flush-func */
  OPT_mno_mdmx = 1348,                       /* -mno-mdmx */
  OPT_mno_mips16 = 1349,                     /* -mno-mips16 */
  OPT_mno_mips3d = 1350,                     /* -mno-mips3d */
  OPT_modd_spreg = 1351,                     /* -modd-spreg */
  OPT_mpaired_single = 1352,                 /* -mpaired-single */
  OPT_mplt = 1353,                           /* -mplt */
  OPT_mr10k_cache_barrier_ = 1354,           /* -mr10k-cache-barrier= */
  OPT_mrelax_pic_calls = 1355,               /* -mrelax-pic-calls */
  OPT_mshared = 1356,                        /* -mshared */
  OPT_msingle_float = 1357,                  /* -msingle-float */
  OPT_msmartmips = 1358,                     /* -msmartmips */
  OPT_msoft_float = 1359,                    /* -msoft-float */
  OPT_msplit_addresses = 1360,               /* -msplit-addresses */
  OPT_msym32 = 1361,                         /* -msym32 */
  OPT_msynci = 1362,                         /* -msynci */
  OPT_mtune_ = 1363,                         /* -mtune= */
  OPT_muninit_const_in_rodata = 1364,        /* -muninit-const-in-rodata */
  OPT_mvirt = 1365,                          /* -mvirt */
  OPT_mvr4130_align = 1366,                  /* -mvr4130-align */
  OPT_mxgot = 1367,                          /* -mxgot */
  OPT_mxpa = 1368,                           /* -mxpa */
  OPT_n = 1369,                              /* -n */
  OPT_no_canonical_prefixes = 1370,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1371,              /* -no-integrated-cpp */
  OPT_no_pie = 1372,                         /* -no-pie */
  OPT_noasmopt = 1373,                       /* -noasmopt */
  OPT_nocpp = 1374,                          /* -nocpp */
  OPT_nodefaultlibs = 1375,                  /* -nodefaultlibs */
  OPT_nolibc = 1376,                         /* -nolibc */
  OPT_nophoboslib = 1377,                    /* -nophoboslib */
  OPT_nostartfiles = 1378,                   /* -nostartfiles */
  OPT_nostdinc = 1379,                       /* -nostdinc */
  OPT_nostdinc__ = 1380,                     /* -nostdinc++ */
  OPT_nostdlib = 1381,                       /* -nostdlib */
  OPT_o = 1382,                              /* -o */
  OPT_p = 1383,                              /* -p */
  OPT_pass_exit_codes = 1384,                /* -pass-exit-codes */
  /* OPT_pedantic = 1385, */                 /* -pedantic */
  OPT_pedantic_errors = 1386,                /* -pedantic-errors */
  OPT_pg = 1387,                             /* -pg */
  OPT_pie = 1388,                            /* -pie */
  OPT_pipe = 1389,                           /* -pipe */
  ...
  /* OPT_specs = 1410, */                    /* -specs */
  OPT_specs_ = 1411,                         /* -specs= */
  OPT_static = 1412,                         /* -static */
  OPT_static_libasan = 1413,                 /* -static-libasan */
  OPT_static_libgcc = 1414,                  /* -static-libgcc */
  OPT_static_libgfortran = 1415,             /* -static-libgfortran */
  OPT_static_libgo = 1416,                   /* -static-libgo */
  OPT_static_liblsan = 1417,                 /* -static-liblsan */
  OPT_static_libmpx = 1418,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1419,          /* -static-libmpxwrappers */
  OPT_static_libphobos = 1420,               /* -static-libphobos */
  ...
  OPT_std_c2x = 1438,                        /* -std=c2x */
  /* OPT_std_c89 = 1439, */                  /* -std=c89 */
  OPT_std_c90 = 1440,                        /* -std=c90 */
  OPT_std_c99 = 1441,                        /* -std=c99 */
  /* OPT_std_c9x = 1442, */                  /* -std=c9x */
  OPT_std_f2003 = 1443,                      /* -std=f2003 */
  OPT_std_f2008 = 1444,                      /* -std=f2008 */
  OPT_std_f2008ts = 1445,                    /* -std=f2008ts */
  OPT_std_f2018 = 1446,                      /* -std=f2018 */
  OPT_std_f95 = 1447,                        /* -std=f95 */
  OPT_std_gnu = 1448,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1449, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1450, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1451,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1452,                    /* -std=gnu++14 */
  OPT_std_gnu__17 = 1453,                    /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1454, */              /* -std=gnu++1y */
  /* OPT_std_gnu__1z = 1455, */              /* -std=gnu++1z */
  OPT_std_gnu__2a = 1456,                    /* -std=gnu++2a */
  OPT_std_gnu__98 = 1457,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1458,                      /* -std=gnu11 */
  OPT_std_gnu17 = 1459,                      /* -std=gnu17 */
  /* OPT_std_gnu18 = 1460, */                /* -std=gnu18 */
  /* OPT_std_gnu1x = 1461, */                /* -std=gnu1x */
  OPT_std_gnu2x = 1462,                      /* -std=gnu2x */
